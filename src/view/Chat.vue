    ...
    <div class="container">
      ...
      <div class="bottom">
        <div class="functions">
          ...
          <div class="fun-li" @click="handleHistory">
            <i class="icon iconfont icon-wenti"></i>
          </div>
        </div>
        <div class="chat">
...
<script type="text/ecmascript-6" scoped>
  ...
  export default{
    ...
    methods: {
      ...
      async handleHistory() {
        if (this.$store.state.roomdetail.infos.length === 0) {
          Alert({
            title: '警告',
            content: '您当前无会话历史聊天记录哦~'
          });
        } else {
          ...
          if (data === 'submit') {
            ...
            this.isloading = true;
            this.$store.dispatch('clearAllMessHistory', params);
            this.isloading = false;
          }
        }
      },
